...
function startCreationOfNewVersion(){
    jQuery.ajax({url     : context_url+"/getLatestVersionUrl",
            success : function(data){
                ...
                jQuery.fancybox('<div style="text-align:center;width:250px;"><span>Please wait, a new version is being created.</span><br/><br/><img src="++resource++jqzoom/zoomloader.gif"/></div>',{'modal':true});
                        ...
                        error   : function(xhr, ajaxOptions, thrownError){
                            if (xhr.status == 504){
                                checkLatestVersion();
                                 ...
                                 jQuery.fancybox('<div style="text-align:center;width:250px;"><span>An internal error occured, please contact the administrator</span></div>',{'modal':false});
                            }
                        }
                });
            }
